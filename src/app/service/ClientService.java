...
public class ClientService {
    ...
    public List<Client> getAllClients(UserResponseDTO user) {
        try {
    ...
    public List<Client> getAllClientsByUserId(int id, UserResponseDTO user) {
        try {
            String token = "Bearer " + user.getToken();
    ...
    public Client getClientById(int id, UserResponseDTO user) {
        try{
            String token = "Bearer " + user.getToken();
    ...
    public void createClient(Client client, UserResponseDTO user) {
        try{
            String token = "Bearer " + user.getToken();
    ...
    public void updateClient(int id, Client client, UserResponseDTO user) {
        try {
            String token = "Bearer " + user.getToken();
    ...
    public void deleteClient(int id, UserResponseDTO user) {
        try {
            String token = "Bearer " + user.getToken();
    ...
    public List<Client> searchClientsByQuery(int userId, String query, UserResponseDTO user) {
        try {
            String token = "Bearer " + user.getToken();
    ...
    public int getActiveClientsCount(UserResponseDTO user) {
