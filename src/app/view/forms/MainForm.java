...
public class MainForm extends JLayeredPane {
    ...
    private void initMenuArrowIcon() {
        ...
        menuButton.setIcon(new FlatSVGIcon("app/icon/svg/" + icon, 0.8f));
    }
    ...
    private void initMenuEvent() {
        menu.addMenuEvent((int index, int subIndex, MenuAction action) -> {
            ...
            if (index == 0) {
                Application.showForm(new Dashboard(this.user));
            } else if (index == 1) {
                if (subIndex == 1) {
                ...
                if(subIndex == 1){
                    ...
                    Application.showForm(new AllClientsView(this.user));
                }
            }else if(index == 4) {
                if (subIndex == 1) {
                ...
                if (subIndex == 3) {
                    Application.showForm(new Incomes(user));
                }
