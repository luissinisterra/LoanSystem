...
public class LoanListView extends JPanel {
    ...
    private void filterTable(String query) {
        List<Loan> loans = this.loanController.searchLoansByQuery(this.user.getId() ,query, this.user);
    ...
    private void resetTable() {
        List<Loan> loans = this.loanController.getAllLoansByUserId(this.user.getId(), this.user);
        model.setRowCount(0); // Limpiar las filas actuales del modelo
    ...
    private JPanel createStatsPanel() {
        ...
        List<Loan> allLoans = this.loanController.getAllLoans(this.user); // Obtener la lista de préstamos
        ...
        int activeLoansCount = this.loanController.getActiveLoansCount(this.user) == 0 ? 0 : this.loanController.getActiveLoansCount(this.user);
    ...
    private void setupEditButtonAction(JButton button) {
        button.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                ...
                Loan loan = this.loanController.getLoanById(Integer.parseInt(id), this.user);
        ...
        button.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    this.loanController.deleteLoan(Integer.parseInt(id), this.user);
                    this.refreshTable();
