...
public class Incomes extends JPanel {
    ...
    public void llenarTabla() {
        try {
            ...
            for (IncomeResponseDTO income : controller.getIncomesByUserID(user.getId(), this.user)) {
    ...
    public void setTotal() {
        try {
            List<IncomeResponseDTO> incomes = controller.getIncomesByUserID(user.getId(), this.user);
            double total = 0;
    ...
    private void eliminarIngreso() {
        ...
        controller.removeIncome(id, this.user);
        llenarTabla();
        setTotal();
    ...
    private void editarIngreso() {
        ...
        IncomeResponseDTO i = controller.getIncomeByID(id, this.user);
    ...
    private void verDetallesIngreso() {
        ...
        JOptionPane.showMessageDialog(null, "ID: " + id + "\n" +
                "Tipo: " + controller.getIncomeByID(id, this.user).getIncomeType() + "\n" +
                "Valor: " + controller.getIncomeByID(id, this.user).getAmmount() + "\n" +
                "Fecha: " + controller.getIncomeByID(id, this.user).getIncomeDate());
    }
    ...
    private Integer getSelectedIncomeID() {
        ...
        if (filaVista >= 0) {
            ...
            List<IncomeResponseDTO> incomes = controller.getIncomes(this.user);
